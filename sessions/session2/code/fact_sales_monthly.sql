...
CREATE INDEX idx_fact_sales_monthly_year ON gold.fact_sales_monthly(year DESC);
CREATE INDEX idx_fact_sales_monthly_year_month ON gold.fact_sales_monthly(year DESC, month);
CREATE INDEX idx_fact_sales_monthly_revenue ON gold.fact_sales_monthly(total_revenue DESC);
